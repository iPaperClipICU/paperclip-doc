...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/1.gif)

# Vol.014 如何科学地消灭敏感词

中国网民第一次发现敏感词的存在，是在 2000 年的 qq 聊天室。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/2.gif)

用于结交陌生朋友的聊天室功能，让敏感内容第一次有了大规模传播的可能，因此，禁词表出现了。

禁词表的规则相当粗暴——只要文本内容包含禁用词，则无法发送，或发送后仅自己可见。直到今天，微信也仍然沿用这一规则。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/3.gif)
...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/5.gif)

另一方面，许多敏感内容是事件，无法仅用单个词描述。

以“金正男机场遇刺”为例，需要“机场”、“金正男”、“遇刺”其中两个词同时出现才能触发清除机制。这就给了其中单个词相当大的替换空间，例如“机场金大胖”、“胖熊机场一日游”，都可以让人联想到该事件。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/6.gif)
...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/7.gif)

但这种方法并不可靠，如“一台独立服务器”就还是会被分为“一/台独/立/服务器”。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/8.gif)
...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/9.gif)
...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/11.gif)
...
![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/13.gif)

那么，一条提到了机场的内容里出现了“遇刺”，该内容是敏感内容的概率 P(b|W) 是多大呢？将上面的结果带入贝叶斯公式中，可以算出概率为 P(b|W) = P(W|b)P(b) / P(W) = 81.1％。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/14.gif)

按此方法可以计算出每个词的敏感概率，根据这个公式就可以计算出该文本为敏感内容的期望，再根据实际情况设定阈值进行处理。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/15.gif)

以“金大胖在机场遇刺”为例，根据「金大胖」、「机场」和「遇刺」三个词的敏感概率，可计算出这句话是敏感内容的概率为 93.9％。

![img](https://cdn.jsdelivr.net/gh/iPaperClipICU/static/image/文字稿/Vol/Vol.014%20如何科学地消灭敏感词/16.gif)
